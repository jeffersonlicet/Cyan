...
<html lang="en">
	...
	<div id="app" style="display:none">
		...
		<div class="container-fluid" style="margin: 0 auto;">
			<a href="https://play.google.com/store/apps/details?id=com.sparkly.selfy" target="_blank"><img height="100" class="img-responsive" style="max-width: 70%; margin: 0 auto" src="<?= URL::to('/'); ?>/img/selfyimage.png"></a>
		<br />
