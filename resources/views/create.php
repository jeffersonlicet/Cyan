	...
	<div id="app" style="display:none">
			...
			<div class="container-fluid">
				...
				<div class="navbar-collapse collapse navbar-inverse-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="javascript:void(0)">Registrarme</a></li>
		...
		<div class="container-fluid">
			<div class="row">
				...
				Si usted no es estudiante y desea usar el sistema por favor comunicarse al <b>0414-2555513</b> o escribir un correo con sus datos a <b>12-11460@usb.ve</b> y con gusto le proporcionaremos una cuenta.
				</div>
